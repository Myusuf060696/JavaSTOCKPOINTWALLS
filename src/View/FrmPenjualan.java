...
public class FrmPenjualan extends javax.swing.JInternalFrame {
    ...
    private DefaultTableModel dtmTransaksi,dtmHawker, dtmProduk;
    ...
    private EntityPenjualan p;
    private EntityTransaksi t;
   ...
   private void aturTable(){
       tabelHeader = new String[]{"Kode Produk","Nama Produk", "Bawa", "Sisa", "Laku","SETOR HAWKER","OMSET HAWKER","Total"};
   ...
   private void refreshIsitabelProduk(){
    ...
    private void initComponents() {
        ...
        if (tabelTransaksi.getColumnModel().getColumnCount() > 0) {
            tabelTransaksi.getColumnModel().getColumn(0).setHeaderValue("Title 1");
            tabelTransaksi.getColumnModel().getColumn(1).setHeaderValue("Title 2");
            tabelTransaksi.getColumnModel().getColumn(2).setHeaderValue("Title 3");
            tabelTransaksi.getColumnModel().getColumn(3).setHeaderValue("Title 4");
        }
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(txtKodeProduk, javax.swing.GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(txtHargaJual, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
                                    .addComponent(txtHargaSP, javax.swing.GroupLayout.Alignment.LEADING))
                                .addGap(0, 0, Short.MAX_VALUE)))
                        .addGap(63, 63, 63)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        p = new EntityPenjualan();
        t = new EntityTransaksi();
        ...
        for(int i=0; i<baris;i++){
            ...
            p.setQty(Integer.parseInt(dtmTransaksi.getValueAt(i,4).toString()));
            t.setLaku(Integer.parseInt(dtmTransaksi.getValueAt(i,4).toString()));
            p.setTotal_jual(Integer.parseInt(dtmTransaksi.getValueAt(i, 7).toString()));
            t.setBawa(Integer.parseInt(dtmTransaksi.getValueAt(i, 2).toString()));
            t.setSisa(Integer.parseInt(dtmTransaksi.getValueAt(i,3).toString()));
    ...
    private void btnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExitActionPerformed
        if(btnExit.getText().equals("Exit")){
            FrmTampilPenjualan p = new FrmTampilPenjualan();
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        dtmTransaksi.addRow(new Object[]{txtKodeProduk.getText(), txtNamaProduk.getText(),txtbawa.getText(),txtSisa.getText(),txtLaku.getText(),setor_hawker,omset_hawker,total});
        txtKodeProduk.setText("");
        txtNamaProduk.setText("");
        txtHargaJual.setText("");
        txtbawa.setText("");
        ...
        total_omset = 0;
        for(int i =0; i<baris;i++){
            total_setor = total_setor + Integer.parseInt(dtmTransaksi.getValueAt(i, 5).toString());
            total_omset = total_omset + Integer.parseInt(dtmTransaksi.getValueAt(i, 6).toString());
        }
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        if(tabelTransaksi.getSelectedRow()>=0){
            ...
            labelSetor.setText(String.valueOf(total_setor));
            labelOmset.setText(String.valueOf(total_omset));
            labelBonus.setText(String.valueOf(bonus));
        }
